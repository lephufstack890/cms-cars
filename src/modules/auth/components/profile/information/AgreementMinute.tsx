...
import { FormAgreementMinuteProfileModel } from '@/modules/auth/models/profile';
import { trans } from '@/utils';

const defaultValues: FormAgreementMinuteProfileModel = {
  expiration_time: '',
  image_fifth: {},
  image_first: {},
  image_fourth: {},
...
export function AgreementMinute() {
  const { isLoading } = useAuth();
  const resolver = yupResolver(getLoginFormSchema());
  const formMethods = useForm<FormAgreementMinuteProfileModel>({ defaultValues, resolver });

  const onSubmit: SubmitHandler<FormAgreementMinuteProfileModel> = (formData) => {
