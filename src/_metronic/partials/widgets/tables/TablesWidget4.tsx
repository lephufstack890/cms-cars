                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-end">
                      <a className="btn btn-icon btn-light-twitter btn-sm me-3" href="#">
                        <i className="bi bi-twitter fs-4" />
                      </a>
                      <a className="btn btn-icon btn-light-facebook btn-sm" href="#">
              ...
              <table className="table align-middle gs-0 gy-3">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="symbol symbol-50px">
                        <img alt="" src={toAbsoluteUrl('/media/svg/avatars/043-boy-18.svg')} />
                      </div>
                    </td>
                    <td>
                      <a className="text-dark fw-bold text-hover-primary mb-1 fs-6" href="#">
                  ...
                  <tr>
                    <td>
                      <div className="symbol symbol-50px">
                        <img alt="" src={toAbsoluteUrl('/media/svg/avatars/014-girl-7.svg')} />
                      </div>
                    </td>
                    <td>
                      <a className="text-dark fw-bold text-hover-primary mb-1 fs-6" href="#">
                  ...
                  <tr>
                    <td>
                      <div className="symbol symbol-50px">
                        <img alt="" src={toAbsoluteUrl('/media/svg/avatars/018-girl-9.svg')} />
                      </div>
                    </td>
                    <td>
                      <a className="text-dark fw-bold text-hover-primary mb-1 fs-6" href="#">
                  ...
                  <tr>
                    <td>
                      <div className="symbol symbol-50px">
                        <img alt="" src={toAbsoluteUrl('/media/svg/avatars/001-boy.svg')} />
                      </div>
                    </td>
                    <td>
                      <a className="text-dark fw-bold text-hover-primary mb-1 fs-6" href="#">
              ...
              <table className="table align-middle gs-0 gy-3">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <div className="symbol symbol-50px">
                        <img alt="" src={toAbsoluteUrl('/media/svg/avatars/047-girl-25.svg')} />
                      </div>
                    </td>
                    <td>
                      <a className="text-dark fw-bold text-hover-primary mb-1 fs-6" href="#">
