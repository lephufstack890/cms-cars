      ...
      <div className="card-body p-0">
        ...
        >
          ...
          <div className="d-flex align-items-center mb-6">
            ...
            <div className="symbol symbol-45px w-40px me-5">
              <span className="symbol-label bg-lighten">
                <KTSVG className="svg-icon-1" path="/media/icons/duotune/maps/map004.svg" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Description */}
            <div className="d-flex align-items-center flex-wrap w-100">
              ...
              <div className="mb-1 pe-3 flex-grow-1">
                <a className="fs-5 text-gray-800 text-hover-primary fw-bold" href="#">
                  Sales
                </a>
          ...
          <div className="d-flex align-items-center mb-6">
            ...
            <div className="symbol symbol-45px w-40px me-5">
              <span className="symbol-label bg-lighten">
                <KTSVG className="svg-icon-1" path="/media/icons/duotune/electronics/elc005.svg" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Description */}
          ...
          <div className="d-flex align-items-center">
            ...
            <div className="symbol symbol-45px w-40px me-5">
              <span className="symbol-label bg-lighten">
                <KTSVG className="svg-icon-1" path="/media/icons/duotune/general/gen005.svg" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Description */}
