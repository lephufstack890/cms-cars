      ...
      <div className="card-body pt-5">
        ...
        <div className="d-flex mb-7">
          ...
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img alt="" className="mw-100" src={toAbsoluteUrl('/media/stock/600x400/img-3.jpg')} />
          </div>
          {/*end::Symbol*/}
          {/*begin::Section*/}
          <div className="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
            ...
            <div className="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
              <a className="fs-5 text-gray-800 text-hover-primary fw-bolder" href="#">
                Cup &amp; Green
              </a>
        ...
        <div className="d-flex mb-7">
          {/*begin::Symbol*/}
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img alt="" className="mw-100" src={toAbsoluteUrl('/media/stock/600x400/img-4.jpg')} />
          </div>
          {/*end::Symbol*/}
          {/*begin::Section*/}
          <div className="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
        ...
        <div className="d-flex mb-7">
          {/*begin::Symbol*/}
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img alt="" className="mw-100" src={toAbsoluteUrl('/media/stock/600x400/img-5.jpg')} />
          </div>
          {/*end::Symbol*/}
          {/*begin::Section*/}
          <div className="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
        ...
        <div className="d-flex mb-7">
          {/*begin::Symbol*/}
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img alt="" className="mw-100" src={toAbsoluteUrl('/media/stock/600x400/img-6.jpg')} />
          </div>
          {/*end::Symbol*/}
          {/*begin::Section*/}
          <div className="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
        ...
        <div className="d-flex">
          {/*begin::Symbol*/}
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img alt="" className="mw-100" src={toAbsoluteUrl('/media/stock/600x400/img-7.jpg')} />
          </div>
          {/*end::Symbol*/}
          {/*begin::Section*/}
          <div className="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
